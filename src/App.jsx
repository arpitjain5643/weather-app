...
const App = () => {
  ...
  const fetchWeather = async (city) => {
    ...
    try {
      ...
      console.log(`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=${unit}&appid=${API_KEY}`)
      ...
      console.log(`https://api.openweathermap.org/data/2.5/forecast?q=${city}&units=${unit}&appid=${API_KEY}`)
